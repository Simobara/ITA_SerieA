...
//         { id: 4, pos: 'AOttavi4', 		name: 'Milan' },
//         { id: 5, pos: 'BOttavi1', 		name: 'Lazio' },
//         { id: 6, pos: 'BOttavi2', 		name: 'Roma' },
//         { id: 7, pos: 'BOttavi3', 		name: 'Juve' },
...
//         { id: 5, pos: 'bottom-36%', 	team1: 'Cosenza', 	team2: 'Sassuolo', 		ris: '2-4' },
...
//         { id: 4, pos: '40%', 			team1: 'Cremonese', team2: 'Reggiana', 		ris: '1-0' },
...
//     SqAQuarti: [
//         { id: 1, pos: '20%', 			team1: 'Inter', 	team2: 'Fiorentina', 	ris: '1-1' },
//         { id: 2, pos: '70%', 			team1: 'Atalanta', 	team2: 'Milan', 		ris: '2-2' },
//     ],
//     SqBQuarti: [
//         { id: 1, pos: '20%', 			team1: 'Lazio', 	team2: 'Roma', 			ris: '3-2' },
//         { id: 2, pos: '70%', 			team1: 'Juve', 		team2: 'Napoli',		ris: '1-1' },
//     ],

// 	// //*------------------------------------------------------------------------------ 2

//     SqASemifinali: [
//         { id: 1, pos: '', 				team1: 'Inter', 	team2: 'Atalanta', 		ris: '0-2' },
//     ],
//     SqBSemifinali: [
//         { id: 1, pos: '', 				team1: 'Lazio', 	team2: 'Juve', 			ris: '1-2' },
//     ],

// 	// //*------------------------------------------------------------------------------ 1

//     Finale: [
//         { id: 1, pos: '', 				team1: 'Atalanta', 	team2: 'Juve', 			ris: '1-2' },
//     ],
// };
...
const Tornei25 = {
	...
	// //*------------------------------------------------------------------------------ ------ 32
    SqATrentaduesimi: [
        { id: 1, pos: '5%', 			team1: 't-A1', 	    team2: 't-A2',		    ris: '' },
        { id: 2, pos: '15%', 			team1: 't-A3',	    team2: 't-A4',   		ris: '' },
        { id: 3, pos: '30%', 			team1: 't-A5', 	    team2: 't-A6',		    ris: '' },
        { id: 4, pos: '40%', 			team1: 't-A7', 	    team2: 't-A8',		    ris: '' },
        { id: 5, pos: 'bottom-36%', 	team1: 't-A9', 	    team2: 't-A10', 		ris: '' },
        { id: 6, pos: 'bottom-26%', 	team1: 't-A11', 	team2: 't-A12', 		ris: '' },
        { id: 7, pos: 'bottom-11%', 	team1: 't-A13',	    team2: 't-A14',   		ris: '' },
        { id: 8, pos: 'bottom-1%', 		team1: 't-A15', 	team2: 't-A16',     	ris: '' },
    ],
    SqBTrentaduesimi: [
        { id: 1, pos: '5%', 			team1: 't-B1', 	    team2: 't-B2',          ris: '' },
        { id: 2, pos: '15%', 			team1: 't-B3', 	    team2: 't-B4',	        ris: '' },
        { id: 3, pos: '30%', 			team1: 't-B5', 	    team2: 't-B6',      	ris: '' },
        { id: 4, pos: '40%', 			team1: 't-B7',      team2: 't-B8',  		ris: '' },
        { id: 5, pos: 'bottom-36%', 	team1: 't-B9',      team2: 't-B10', 		ris: '' },
        { id: 6, pos: 'bottom-26%', 	team1: 't-B11',     team2: 't-B12', 		ris: '' },
        { id: 7, pos: 'bottom-11%', 	team1: 't-B13',     team2: 't-B14',		    ris: '' },
        { id: 8, pos: 'bottom-1%', 		team1: 't-B15', 	team2: 't-B16', 		ris: '' },
    ],
	// //*------------------------------------------------------------------------------ ------ 16
    SqASedicesimi: [
        { id: 1, pos: '10%', 			team1: 's-A1',      team2: 's-A2',          ris: '' },
        { id: 2, pos: '35%', 			team1: 's-A3',      team2: 's-A4',          ris: '' },
        { id: 3, pos: '31%', 			team1: 's-A5',      team2: 's-A6',          ris: '' },
        { id: 4, pos: '6%', 			team1: 's-A7',      team2: 's-A8',          ris: '' },
    ],
    SqBSedicesimi: [
        { id: 1, pos: '10%', 			team1: 's-B1',    	team2: 's-B2', 	        ris: '' },
        { id: 2, pos: '35%', 			team1: 's-B3', 	    team2: 's-B4',	        ris: '' },
        { id: 3, pos: '31%', 			team1: 's-B5',      team2: 's-B6',          ris: '' },
        { id: 4, pos: '6%', 			team1: 's-B7',      team2: 's-B8', 		    ris: '' },
    ],
	// //*------------------------------------------------------------------------------ ------  8
    SqAOttavi: [
	...
	// //*------------------------------------------------------------------------------ ------  2
    SqASemifinali: [
        { id: 1, pos: '', 				team1: 'sf-A1',     team2: 'sf-A2',         ris: '' },
    ],
    SqBSemifinali: [
        { id: 1, pos: '', 				team1: 'sf-B1',     team2: 'sf-B2',         ris: '' },
    ],
	// //*------------------------------------------------------------------------------ ------  1
    Finale: [
        { id: 1, pos: '', 				team1: 'F-A', 	    team2: 'F-B', 	        ris: '' },
    ],
};
//! -------------------------------------------------------------------------------------- -------------------------------------------
