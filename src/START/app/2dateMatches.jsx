...
const DateIncontri25 = [
    {
    //*                           ---AGOSTO---
	Agosto: {
		ItaSerieA: [
			{ date: 17, details: { event: 'giornata1',          teams: '' } },
            { date: 18, details: { event: 'giornata1',          teams: '' } },
			{ date: 19, details: { event: 'giornata1',          teams: '' } },
						
            { date: 24, details: { event: 'giornata2',          teams: '' } },
            { date: 25, details: { event: 'giornata2',          teams: '' } },
            { date: 26, details: { event: 'giornata2',          teams: '' } },

            { date: 30, details: { event: 'giornata3',          teams: '' } },
            { date: 31, details: { event: 'giornata3',          teams: '' } },
        ],
        ItaCoppaItalia: [
            { date: 10, details: { event: 'Turno1',             teams: '' } },
            { date: 11, details: { event: 'Turno1',             teams: '' } },
        ...
        EuroChampionsLeague: [
            ...
            { date: 20, details: { event: 'Playoff Andata',     teams: '' } },
            { date: 21, details: { event: 'Playoff Andata',     teams: '' } },

            { date: 27, details: { event: 'Playoff Ritorno',    teams: '' } },
            { date: 28, details: { event: 'Playoff Ritorno',    teams: '' } },
        ],
        EuroEuropaLeague: [
        ...
        EuroSuperCoppaUefa: [
            { date: 14, details: { event: 'FINALE',             teams: '' } }
        ]
    },
    //*                           ---SETTEMBRE---
	Settembre: {
	...
	Novembre: {
        ItaSerieA: [
            { date:  1, details: { event: 'giornata11',         teams: '' } },
            { date:  2, details: { event: 'giornata11',         teams: '' } },
            { date:  3, details: { event: 'giornata11',         teams: '' } },

            { date:  8, details: { event: 'giornata12',         teams: '' } },
            { date:  9, details: { event: 'giornata12',         teams: '' } },
            { date: 10, details: { event: 'giornata12',         teams: '' } },
        
            { date: 23, details: { event: 'giornata13',         teams: '' } },
            { date: 24, details: { event: 'giornata13',         teams: '' } },
            { date: 25, details: { event: 'giornata13',         teams: '' } },

            { date: 29, details: { event: 'giornata14',         teams: '' } },
            { date: 30, details: { event: 'giornata14',         teams: '' } },
        ],
        ItaCoppaItalia: [
            {}
        ],
        EuroChampionsLeague: [
            { date:  5, details: { event: '4giornata',          teams: '' } },
            { date:  6, details: { event: '4giornata',          teams: '' } },

            { date: 26, details: { event: '5giornata',          teams: '' } },
            { date: 27, details: { event: '5giornata',          teams: '' } },
        ],
        EuroEuropaLeague: [
            { date:  7, details: { event: '3giornata',          teams: '' } },
            { date: 28, details: { event: '4giornata',          teams: '' } },
        ],
        EuroConferenceLeague: [
            { date:  7, details: { event: '3giornata',          teams: '' } },
            { date: 28, details: { event: '4giornata',          teams: '' } },
        ...
        Nazionale: [
            { date: 14, details: { event: 'Qualificazioni',     teams: '' } },
            { date: 15, details: { event: 'Qualificazioni',     teams: '' } },
            { date: 16, details: { event: 'Qualificazioni',     teams: '' } },
            { date: 17, details: { event: 'Qualificazioni',     teams: '' } },
            { date: 18, details: { event: 'Qualificazioni',     teams: '' } },
            { date: 19, details: { event: 'Qualificazioni',     teams: '' } },
        ],
    },
    //*                           ---DICEMBRE---
	Dicembre: {
        ItaSerieA: [
            ...
            { date:  7, details: { event: 'giornata15',         teams: '' } },
            { date:  8, details: { event: 'giornata15',         teams: '' } },
            { date:  9, details: { event: 'giornata15',         teams: '' } },

            { date: 14, details: { event: 'giornata16',         teams: '' } },
            { date: 15, details: { event: 'giornata16',         teams: '' } },
            { date: 16, details: { event: 'giornata16',         teams: '' } },

            { date: 21, details: { event: 'giornata17',         teams: '' } },
            { date: 22, details: { event: 'giornata17',         teams: '' } },
            { date: 23, details: { event: 'giornata17',         teams: '' } },

            { date: 27, details: { event: 'giornata18',         teams: '' } },
            { date: 28, details: { event: 'giornata18',         teams: '' } },
            { date: 29, details: { event: 'giornata18',         teams: '' } }
        ],
        ItaCoppaItalia: [
            { date:  3, details: { event: 'Ottavi',             teams: '' } },
	...
	Gennaio: {
        ItaSerieA: [
            { date:  4, details: { event: 'giornata19',         teams: '' } },
            { date:  5, details: { event: 'giornata19',         teams: '' } },
        
            { date: 10, details: { event: 'giornata20',         teams: '' } },
            { date: 11, details: { event: 'giornata20',         teams: '' } },
            { date: 12, details: { event: 'giornata20',         teams: '' } },
            { date: 13, details: { event: 'giornata20',         teams: '' } },
        
            { date: 17, details: { event: 'giornata21',         teams: '' } },
            { date: 18, details: { event: 'giornata21',         teams: '' } },
            { date: 19, details: { event: 'giornata21',         teams: '' } },
        
            { date: 25, details: { event: 'giornata22',         teams: '' } },
            { date: 26, details: { event: 'giornata22',         teams: '' } },
            { date: 27, details: { event: 'giornata22',         teams: '' } },
        ...
        ItaSuperCoppa: [
            { date:  3, details: { event: 'Semifinale',         teams: '' } },
            { date:  4, details: { event: 'Semifinale',         teams: '' } },
            { date:  7, details: { event: 'Semifinale',         teams: '' } },
        ],
    },
    //*                           ---FEBBRAIO---
	Febbraio: {
        ItaSerieA: [
            { date:  1, details: { event: 'giornata23',         teams: '' } },
            { date:  2, details: { event: 'giornata23',         teams: '' } },
            { date:  3, details: { event: 'giornata23',         teams: '' } },
        
            { date:  8, details: { event: 'giornata24',         teams: '' } },
            { date:  9, details: { event: 'giornata24',         teams: '' } },
            { date: 10, details: { event: 'giornata24',         teams: '' } },
        
            { date: 15, details: { event: 'giornata25',         teams: '' } },
            { date: 16, details: { event: 'giornata25',         teams: '' } },
            { date: 17, details: { event: 'giornata25',         teams: '' } },
        
            { date: 22, details: { event: 'giornata26',         teams: '' } },
            { date: 23, details: { event: 'giornata26',         teams: '' } },
            { date: 24, details: { event: 'giornata26',         teams: '' } }, 
        ],
        ItaCoppaItalia: [
            { date:  4, details: { event: 'Quarti',             teams: '' } },
            { date:  5, details: { event: 'Quarti',             teams: '' } },
            { date:  6, details: { event: 'Quarti',             teams: '' } },

            { date: 26, details: { event: 'Quarti',             teams: '' } },
            { date: 27, details: { event: 'Quarti',             teams: '' } },
        ],
        EuroChampionsLeague: [
            { date: 11, details: { event: 'Playoff',            teams: '' } },
            { date: 12, details: { event: 'Playoff',            teams: '' } },

            { date: 18, details: { event: 'Playoff',            teams: '' } },
            { date: 19, details: { event: 'Playoff',            teams: '' } },
        ],
        EuroEuropaLeague: [
            { date: 13, details: { event: 'Playoff',            teams: '' } },
            { date: 20, details: { event: 'Playoff',            teams: '' } },
        ],
        EuroConferenceLeague: [
            { date: 13, details: { event: 'Playoff',            teams: '' } },
            { date: 20, details: { event: 'Playoff',            teams: '' } },
	...
	Marzo: {
        ItaSerieA: [
            ...
            { date: 14, details: { event: 'giornata29',         teams: '' } },
            { date: 15, details: { event: 'giornata29',         teams: '' } },
            { date: 16, details: { event: 'giornata29',         teams: '' } },
        
            { date: 29, details: { event: 'giornata30',         teams: '' } },
            { date: 30, details: { event: 'giornata30',         teams: '' } },
            { date: 31, details: { event: 'giornata30',         teams: '' } },
        ],
        ItaCoppaItalia: [
            {}
        ],
        EuroChampionsLeague: [
            ...
            { date: 11, details: { event: 'Ottavi',             teams: '' } },
            { date: 12, details: { event: 'Ottavi',             teams: '' } },
        ],
        EuroEuropaLeague: [
            { date:  6, details: { event: 'Ottavi',             teams: '' } },
        ...
        Nazionale: [
            { date: 20, details: { event: 'Qualificazioni',     teams: '' } },
            { date: 21, details: { event: 'Qualificazioni',     teams: '' } },
            { date: 22, details: { event: 'Qualificazioni',     teams: '' } },
            { date: 23, details: { event: 'Qualificazioni',     teams: '' } },
            { date: 24, details: { event: 'Qualificazioni',     teams: '' } },
            { date: 25, details: { event: 'Qualificazioni',     teams: '' } },
        ],
    },
    //*                           ---APRILE---
	Aprile: {
        ItaSerieA: [
            { date:  4, details: { event: 'giornata31',         teams: '' } },
            { date:  5, details: { event: 'giornata31',         teams: '' } },
            { date:  6, details: { event: 'giornata31',         teams: '' } },
            { date:  7, details: { event: 'giornata31',         teams: '' } },
        ...
        EuroChampionsLeague: [
            { date:  8, details: { event: 'Quarti',             teams: '' } },
            { date:  9, details: { event: 'Quarti',             teams: '' } },

            { date: 15, details: { event: 'Quarti',             teams: '' } },
            { date: 16, details: { event: 'Quarti',             teams: '' } },
        
            { date: 29, details: { event: 'Semifinali',         teams: '' } },
            { date: 30, details: { event: 'Semifinali',         teams: '' } },
        ],
        EuroEuropaLeague: [
            { date: 10, details: { event: 'Quarti',             teams: '' } },
	...
	Maggio: {
		ItaSerieA: [
			{ date:  3, details: { event: 'giornata35', teams: '' } },
			{ date:  4, details: { event: 'giornata35', teams: '' } },
            { date:  5, details: { event: 'giornata35', teams: '' } },
			...
			{ date: 16, details: { event: 'giornata37', teams: '' } },	
            { date: 17, details: { event: 'giornata37', teams: '' } },
			{ date: 18, details: { event: 'giornata37', teams: '' } },
            { date: 19, details: { event: 'giornata37', teams: '' } },
		...
		EuroChampionsLeague: [
			{ date:  6, details: { event: 'Semifinali', teams: '' } },
			{ date:  7, details: { event: 'Semifinali', teams: '' } },
                
            { date: 31, details: { event: 'FINALE',     teams: '' } }
		],
		EuroEuropaLeague: [
			{ date:  1, details: { event: 'Semifinali', teams: '' } },
            { date:  8, details: { event: 'Semifinali', teams: '' } },
			{ date: 21, details: { event: 'FINALE   ',  teams: '' } },
		],
		EuroConferenceLeague: [
			{ date:  1, details: { event: 'Semifinali', teams: '' } },
				...
				{ date: 28, details: { event: 'FINALE',     teams: '' } },
			],
			Nazionale: [
				// Aggiungi qui eventuali date e dettagli se presenti
			],
...
//! -------------------------------------------------------------------------------------- -------------------------------------------
export const DateIncontri = DateIncontri25
//! -------------------------------------------------------------------------------------- -------------------------------------------
