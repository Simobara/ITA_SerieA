...
export const nomiSquadre = {
    ...
    Rom:    { name: 'Roma',       isTeam: 'A',     AnniA: { Consct: 72, Ult: 1953 },       logo: LogoRoma,         style: {top: '44.8%', left: '48.2%' },    link: ''},
    //*--- ---- ---
    Laz:    { name: 'Lazio',      isTeam: '',      AnniA: { Consct: 36, Ult: 1989 },       logo: LogoLazio,        style: {top: '44.8%', left: '48.2%' },    link: ''},
    Udi:    { name: 'Udinese',    isTeam: 'B',     AnniA: { Consct: 29, Ult: 1996 },       logo: LogoUdinese,      style: {top: '1%',    left: '55%'   },    link: ''},
    Fio:    { name: 'Fiorentina', isTeam: '',      AnniA: { Consct: 20, Ult: 2005 },       logo: LogoFiorentina,   style: {top: '24%',   left: '38%'   },    link: ''},
    ...
    Emp:    { name: 'Empoli',     isTeam: 'B',     AnniA: { Consct:  3, Ult: 2022 },       logo: LogoEmpoli,       style: {top: '26%',   left: '37%'   },    link: ''},
