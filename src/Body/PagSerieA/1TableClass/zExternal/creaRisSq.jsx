        ...
        if (partita.team1 === nomeSquadra || partita.team2 === nomeSquadra) {
          ...
          if (resultsTrimmed === "" && isCasa) {
            ...
            if (isATeamCurrent && isBTeamOpponent && partita.pron.trim() === "") {
              resultsTrimmed = "9-8";
              partita.pron = "1 Ab"; // Aggiorna anche il pronostico come vittoria per la squadra A
            }
          }
          ...
          if (resultsTrimmed === "" && isCasa) {
            ...
            if (isBTeamCurrent && isBTeamOpponent && partita.pron.trim() === "") {
              resultsTrimmed = "9-8";
              partita.pron = "1 bb"; // Aggiorna anche il pronostico come vittoria per la squadra B
            }
          }
