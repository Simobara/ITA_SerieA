...
const useGetSquadreOrdSort = (sqSelected, nomiSquadre, completeClouSelected, punteggiAggiornati, getPunteggioVirtuale, getPunteggioVisualizzato) => {
  return useMemo(() => {
...
export default useGetSquadreOrdSort;
