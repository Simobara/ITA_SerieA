...
const Day = ({ titleDayy, partite = [], resetAll, occhioApertoPartita, setOcchioApertoPartita }) => {
  ...
  const getClassNames = (titleDayy) => {
    ...
    return `${bgColor} text-white text-sm font-bold uppercase text-start sm:py-[0] ml-[1rem] my-[-1.5rem] sm:my-[-0.4rem] sm:ml-0 md:ml-[2rem] md:lg-[1rem] xl:ml-[2rem] pt-[0] sm:pl-[0.5rem] w-[2.5rem] sm:w-[4.5rem] sm:pt-0 mt-0`;
  };
