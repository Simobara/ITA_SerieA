    ...
    <>
      ...
      >
        <div className="relative flex items-center justify-center xs:text-xs sm:text-sm ">
          <div className=" ml-[-1rem] sm:ml-[-2rem]  md:ml-[-4rem] lg:ml-[-1rem] sm:mr-1 sm:p-[0.354rem] w-[2.5rem] text-gray-800">
          ...
          {!isPartitaInCoppiaRegSelected && (
            <div className={`{sm:relative absolute  flex ml-[4rem] sm:pl-0 hover:cursor-context-menu z-10 select-none }`}>
