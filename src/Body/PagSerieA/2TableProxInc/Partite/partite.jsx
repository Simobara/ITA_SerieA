...
const Partite = ({ resetAll, occhioApertoPartita, setOcchioApertoPartita }) => {
  ...
  return (
    ...
    <div className=" relative overflow-y-hidden flex flex-col items-left overflow-x-hidden xs:text-xs sm:text-xl border border-x-0 rounded-3xl border-pink-800 py-[1.5rem] min-w-[17rem] max-h-[90%]">
