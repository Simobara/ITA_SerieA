  ...
  return (
    <>
      ...
      <div className="overflow-y-hidden lg:w-[1299px] grid grid-cols-1 md:grid-cols-10 md:grid-rows-[auto,1fr] lg:flex lg:flex-nowrap">
        ...
        <div className="overflow-hidden sm:overflow-y-auto min-w-[98vw] sm:min-w-[40%] md:col-span-4 md:row-span-2 md:min-h-[90vh] lg:min-w-[18rem] lg:min-h-[95vh] xl:max-w-[100%] xl:max-h-[95vh]">
        ...
        <div className="overflow-hidden overflow-y-auto sm:overflow-y-auto sm:overflow-hidden min-w-[98vw] sm:min-w-[60%] md:col-span-6 md:row-span-1 md:min-h-[30vh] md:max-h-[30vh] lg:min-w-[30rem] lg:min-h-[95vh] xl:max-w-[100%] xl:max-h-[95vh]">
        ...
        <div className="overflow-hidden overflow-y-auto md:min-h-0 min-w-[98vw] sm:min-w-full md:col-span-6 md:row-span-1 lg:min-w-[30rem] xl:max-w-[100%]">
