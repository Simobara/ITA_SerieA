...
const PagSerieA = () => {
  return (
    <>
      ...
      {/* <div className="w-6 bg-black"></div> */}
      {/* </div> */}
      <div className="overflow-hidden lg:w-[1299px] grid grid-cols-1 md:grid-cols-10 md:grid-rows-[auto,1fr] lg:flex lg:flex-nowrap">
        {/* Prima sezione: occupa il 30% sui tablet */}
        <div className="overflow-y-scroll sm:overflow-y-auto min-w-[98vw] sm:min-w-[40%] md:col-span-3 md:row-span-2 md:min-h-[100vh] lg:min-w-[18rem] lg:min-h-[95vh] xl:max-w-[100%] xl:max-h-[95vh]">
        ...
        <div className="overflow-y-scroll sm:overflow-y-auto min-w-[98vw] sm:min-w-[60%] md:col-span-7 md:row-span-1 md:min-h-[30vh] md:max-h-[30vh] lg:min-w-[30rem] lg:min-h-[95vh] xl:max-w-[100%] xl:max-h-[95vh]">
        ...
        <div className="overflow-y-auto md:min-h-0 min-w-[98vw] sm:min-w-full md:col-span-7 md:row-span-1 lg:min-w-[30rem] xl:max-w-[100%]">
